...
function InfrasChart() {
	...
	return (
		<>
			<div className="flex flex-row justify-evenly items-center flex-wrap gap-8 p-8">
				{data.map((infra, index) => (
					<div
						className="antialiased text-gray-900 w-md"
						key={index}>
						<div className="h-fit flex items-center justify-center">
							<div className="relative w-full">
								...
								/>
								<div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2 p-6 bg-gray-200 z-[99999] w-[80%] shadow-lg">
